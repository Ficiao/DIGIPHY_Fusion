...
namespace Fusion.Addons.ConnectionManagerAddon
{
    ...
    public class ConnectionManager : MonoBehaviour, INetworkRunnerCallbacks
    {
        ...
        [SerializeField] private GameObject _connect4Prefab;
        ...
        public void OnPlayerJoinedHostMode(NetworkRunner runner, PlayerRef player)
        {
            ...
            if (runner.IsServer && userPrefab != null)
            {
                ...
                runner.Spawn(_connect4Prefab, position: _connect4Location.position, rotation: _connect4Location.rotation); 
                runner.Spawn(_chessPrefab, position: _chessLocation.position, rotation: _chessLocation.rotation); 
            }
        }
