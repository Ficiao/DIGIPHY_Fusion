...
*/
                        ...
                        {
                            XrSelectable selectable = hit.collider.GetComponent<XrSelectable>();
                            if(selectable != null)
                            {
                                selectable.Selected();
                                didTouch = true;
        ...
        void CheckUngrab()
        {
            ...
            bool shouldUngrab = !Mouse.current.leftButton.wasReleasedThisFrame && !Mouse.current.leftButton.isPressed;
            shouldUngrab = shouldUngrab || (grabbed != null && grabbed.ShouldUngrab);
            if (shouldUngrab)
            {
                if (grabbed != null)
                {
                    //grabbed.ShouldUngrab = false;
                    grabbed = null;
